...
<html>
    ...
    <body><%@include file="AdminNavbar.jsp" %>
        <div class="main">
            ...
            <div class="active">
                ...
                <%
                    ...
                    try {
                        ...
                        ps = conn.prepareStatement("select o.oid, o.pid, o.image, o.sid, o.price, o.quantity, o.pmethod, o.orderdatetime, p.pname from orders o, product p where o.pid=p.pid and sid=?");
                        ps.setString(1, gid);
                        rs = ps.executeQuery();
                %>
                ...
                <div class="orders">
                    ...
                    <div class="order">
                        ...
                        <div style="width: 20%" class="order-info">
